  ...
  return (
    <div className="homepage-container">
      ...
      <nav className="homepage-navbar">
        ...
        <div className="nav-actions">
          {isAuthenticated ? (
            ...
            <>
              <Link to="/guide" className="nav-button guide">
                Hướng dẫn
              </Link>
      ...
      <header className="hero-section">
        ...
        <h2>
          Biến tài liệu PDF, DOCX và cả file Ghi âm thành các bộ đề thi hoàn
          chỉnh chỉ trong vài giây.
        </h2>
        <p>
          Sử dụng sức mạnh của AI để tự động hóa việc soạn đề, đánh giá chất
          lượng và quản lý thư viện câu hỏi của bạn.
        </p>
      ...
      <section className="how-it-works">
        ...
        <div className="steps-container">
          <div className="step-card">
            ...
            <p>
              Tải lên file PDF, DOCX, TXT hoặc file âm thanh (MP3, WAV, M4A).
            </p>
          </div>
          <div className="step-card">
            {/* <FaBrain size={40} /> */}
            ...
            <p>
              AI tự động phân tích, tóm tắt, tạo câu hỏi và tự chấm điểm chất
              lượng từng câu.
            </p>
          </div>
          <div className="step-card">
            ...
            <p>
              Chỉnh sửa, lưu vào thư viện, tạo đề thi và chia sẻ công khai cho
              người khác làm bài.
            </p>
          </div>
        </div>
      ...
      <section className="features-section">
        ...
        <div className="features-grid">
          <div className="feature-card">
            ...
            <p>
              Một tính năng độc đáo cho phép bạn biến các bài giảng, cuộc họp
              (MP3, WAV) thành bộ câu hỏi ôn tập.
            </p>
          </div>
          <div className="feature-card">
            {/* <FaBrain size={30} /> */}
            ...
            <p>
              Mỗi câu hỏi được AI tự chấm điểm (Accuracy, Clarity...) giúp bạn
              biết câu nào tốt nhất.
            </p>
          </div>
          <div className="feature-card">
            {/* <FaShareAlt size={30} /> */}
            ...
            <p>
              Tổ chức câu hỏi thành các đề thi hoàn chỉnh và chia sẻ qua một
              link công khai cho mọi người.
            </p>
          </div>
          <div className="feature-card">
            {/* <FaFilePdf size={30} /> */}
            ...
            <p>
              Lưu trữ đề thi và đáp án của bạn dưới dạng file PDF có thể in ấn
              ngay lập tức.
            </p>
          </div>
        </div>
      ...
      <section className="final-cta">
        ...
        <p>
          Tham gia cùng hàng ngàn giáo viên, nhà quản lý đào tạo và sinh viên
          đang tự động hóa công việc của họ.
        </p>
        <Link to="/register" className="hero-cta-button">
      ...
      <footer className="homepage-footer">
        <p>
          © {new Date().getFullYear()} Ultimate MCQs Agent. Phát triển bởi Bùi
          Ngọc Sơn và Trần Trọng Thuận.
        </p>
      </footer>
    </div>
  );
