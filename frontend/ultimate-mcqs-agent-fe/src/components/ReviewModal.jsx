...
function QuestionReviewCard({
  ...
  return (
    <div className="question-card">
      <div className="card-header" onClick={() => setIsEditing(true)}>
        {" "}
        {/* Click để sửa */}
      ...
      <div className="card-content">
          ...
          {question.options.map((opt, i) => {
            ...
            return (
              <li
                key={i}
                className={
                  letter === question.answer_letter ? "correct-answer" : ""
                }
              >
                {opt}
              </li>
        ...
        <div className="eval-details">
          ...
          <ul>
            <li>Độ chính xác (50): {eval_scores.accuracy || 0}</li>
            <li>Mức độ bám sát (25): {eval_scores.alignment || 0}</li>
            <li>
              Chất lượng đáp án nhiễu (20): {eval_scores.distractors || 0}
            </li>
            <li>Độ rõ ràng (5): {eval_scores.clarity || 0}</li>
          </ul>
        </div>
      </div>
    </div>
        ...
        <div className="modal-body">
          ...
          <div className="source-notification">
            ...
            {result.mode === "summary+mcqs" && (
              <span>
                Các câu hỏi dưới đây được tạo dựa trên{" "}
                <strong>bản tóm tắt</strong>.
              </span>
            )}
            {result.mode === "mcqs" && (
              <span>
                Các câu hỏi dưới đây được tạo dựa trên{" "}
                <strong>nội dung đầy đủ</strong> của tài liệu.
              </span>
            )}
            {!result.mode && <span>Nguồn gốc câu hỏi: Không rõ.</span>}
          </div>
